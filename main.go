...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	// Return posts from elasticsearch
	// change from go object to json based on the schema
...
func saveToGCS(r io.Reader, objectName string) (*storage.ObjectAttrs, error) {
	...
	// set allUsers as readonly(use service account to identify the client)
